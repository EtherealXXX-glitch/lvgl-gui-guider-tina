...
LV_IMG_DECLARE(_icn_slider_alpha_32x32);
LV_IMG_DECLARE(_btn_list_play_alpha_89x89);
LV_IMG_DECLARE(_btn_list_play_alpha_89x89);
LV_IMG_DECLARE(_btn_list_play_alpha_89x89);
LV_IMG_DECLARE(_btn_list_play_alpha_89x89);
LV_IMG_DECLARE(_btn_list_play_alpha_89x89);
LV_IMG_DECLARE(_btn_list_play_alpha_89x89);
LV_IMG_DECLARE(_btn_list_play_alpha_89x89);
LV_IMG_DECLARE(_btn_list_pause_alpha_89x89);
LV_IMG_DECLARE(_cover_1_alpha_224x224);
LV_IMG_DECLARE(_btn_play_alpha_102x102);
LV_IMG_DECLARE(_btn_play_alpha_102x102);
LV_IMG_DECLARE(_btn_pause_alpha_102x102);
LV_IMG_DECLARE(_btn_pause_alpha_102x102);
LV_IMG_DECLARE(_cover_2_alpha_224x224);
LV_IMG_DECLARE(_cover_3_alpha_224x224);
LV_IMG_DECLARE(_wave_bottom_alpha_1024x63);
LV_IMG_DECLARE(_wave_top_alpha_1024x63);
LV_IMG_DECLARE(_btn_rnd_alpha_32x32);
LV_IMG_DECLARE(_btn_loop_alpha_32x32);
LV_IMG_DECLARE(_btn_prev_alpha_78x78);
LV_IMG_DECLARE(_btn_next_alpha_78x78);
LV_IMG_DECLARE(_icn_chat_alpha_32x32);
LV_IMG_DECLARE(_icn_heart_alpha_32x32);
LV_IMG_DECLARE(_icn_download_alpha_32x32);
